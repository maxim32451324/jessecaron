  ...
  return (
    <>
      ...
      <style>{`
        ...
        .acl-item { display:flex; justify-content:space-between; align-items:center; gap:14px; border:1px solid var(--line-d); padding:18px 20px; background:var(--ink-2); transition:.2s; }
        .acl-item:hover { border-color:var(--blue); }
        ...
        .cform input:focus, .cform select:focus, .cform textarea:focus { border-color:var(--blue); outline:none; }
