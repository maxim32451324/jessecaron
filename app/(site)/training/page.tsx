  ...
  return (
    <>
      ...
      <style>{`
        ...
        .tcard { background:var(--ink); display:flex; flex-direction:column; transition:.3s; }
        .tcard:hover { background:var(--ink-2); }
        .tcard__img { aspect-ratio:16/10; overflow:hidden; }
        .tcard__img img { width:100%; height:100%; object-fit:cover; filter:grayscale(.6) brightness(.7); transition:.5s; }
        .tcard:hover .tcard__img img { filter:grayscale(0) brightness(.85); transform:scale(1.04); }
        ...
        .tcard:hover .tcard__go .ar { transform:translateX(5px); }
